...
--    properties = {  tag = "5soc" } },
    ...
    ruled.client.append_rule {
        rule       = { name = "PGPLOT Window 1" },
        properties = {  tag = "9"               }
    }
    ruled.client.append_rule {
        rule       = { name = "PGPLOT Window 2" },
        properties = {  tag = "9"               }
    }
    ruled.client.append_rule {
        rule       = { name = "PGPLOT Window 3" },
        properties = {  tag = "9"               }
    }
    ruled.client.append_rule {
        rule       = { name = "PGPLOT Window 4" },
        properties = {  tag = "9"               }
    }
    ruled.client.append_rule {
        rule       = { name = "PGPLOT Window 5" },
        properties = {  tag = "9"               }
    }
    ruled.client.append_rule {
        rule       = { name = "PGPLOT Window 6" },
        properties = {  tag = "9"               }
    }
    ruled.client.append_rule {
        rule       = { name = "PGPLOT Window 7" },
        properties = {  tag = "9"               }
    }
    ruled.client.append_rule {
        rule       = { name = "PGPLOT Window 8" },
        properties = {  tag = "9"               }
    }
    ruled.client.append_rule {
        rule       = { name = "RustDesk"     },
